...
import { r as reactExports } from './__federation_shared_react-BT1Cw0X2.js';
...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-BT1Cw0X2.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'products':{url:'https://localhost:3001/assets/remoteEntry.js',format:'esm',from:'vite'},
  'cart':{url:'https://localhost:3002/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'18.2.0':{get:()=>get(new URL('__federation_shared_react-BT1Cw0X2.js', import.meta.url).href, remoteFrom), loaded:1}}
...
const __federation_var_productsproductList = await __federation_method_getRemote("products" , "./productList");
 let Products = __federation_method_unwrapDefault(__federation_var_productsproductList); 
const __federation_var_cartcartList = await __federation_method_getRemote("cart" , "./cartList");
 let Cart = __federation_method_unwrapDefault(__federation_var_cartcartList); 
const Container = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Shopping App" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Products list" }),
...
const reportWebVitals = onPerfEntry => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    __vitePreload(() => import('./web-vitals-DIAcLKHX.js'),true?__vite__mapDeps([]):void 0).then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      getCLS(onPerfEntry);
      getFID(onPerfEntry);
      getFCP(onPerfEntry);
      getLCP(onPerfEntry);
...
const root = client.createRoot(document.getElementById("container"));
root.render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, {}) })
);
reportWebVitals();
